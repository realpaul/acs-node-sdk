...
// Const definition
const DEFAULT_API_ENTRY_POINT = 'http://api-local.cloud.appcelerator.com',
	DEFAULT_APP_OPTIONS = {
...
for (var i = 0; i < acsCollection.objectList.length; i++) {
	...
	var acsObjectName = (acsObject.restObject ? acsObject.restObject : acsObjectKey).toLowerCase();
	for (var j = 0; j < acsObject.methodList.length; j++) {
		...
		var methodName = acsObjectName + acsObjectMethodKeyCapitalized;
